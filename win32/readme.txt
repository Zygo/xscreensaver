...
However as a word of warning, it may be slow once you
select it. Occassionally the display settings appears
to hang. It hasn't and comes back after 20-30 seconds
(with the little screen displaying a mode). I'm not
sure whats causing this. This will only happen when
you change xlock95 to be your screensaver (or
access the screensaver tab while xlock95 is the
active screensaver). Once its set it will run fine,
whenever the screensaver normally kicks in.
...
time, there are 71 modes. These are:

Ant, Ant3D, Apollonian, Ball, Blot, Bouboule, Braid, Bug, Clock,
Coral, Crystal, Daisy, Deco, Demon, Discrete, Dragon, Drift, Euler2D,
Fadeplot, Fiberlamp, Flame, Flow, Forest, Galaxy, Grav, Helix, Hop,
Hyper, Ico, Juggle, Julia, Kaleid, Laser, Life, Life1D, Life3D,
Lightning, Lisa, Lissie, Loop, Lyapunov, Mandelbrot, Maze, Mountain,
Munch, Petal, Petri, Polyominoes, Pyro, Qix, Roll, Rotor, Scooter,
Sierpinski, Space, Sphere, Spiral, Spline, Swarm, Tetris, Thornbird,
Tik_tak, Toneclock, Triangle, Tube, Turtle, Vines, Voters, Wire,
Worm, Xjack
...
crystal: xor errors in beginning
julia: red square dot
life1d: fade does an erase
petri: only red germs
scooter: red rects
tube: needs closure for stars
