...
static const char *bsod_defaults [] = {
  ...
  ".solaris.font:	Gallant12x22 12, Courier Bold 12",
  ".solaris.bigFont:	Gallant12x22 24, Courier Bold 24",

  /* "Luxi Mono" was the Red Hat console font. */
  ".linux.font:		Luxi Mono 12, Courier Bold 12",
  ".linux.bigFont:	Luxi Mono 24, Courier Bold 24",
