...
$ link xscreensaver-command,vms_12.opt/opt
$ link xscreensaver,demo,dialogs,lock,stderr,subprocs,timers,windows, -
  getpwnam,getpwuid,hpwd,validate,vms_12.opt/opt
$ else
$! Else, link with X11R4 libraries
$ link xscreensaver-command,vms.opt/opt
$ link xscreensaver,demo,dialogs,lock,stderr,subprocs,timers,windows, -
  getpwnam,getpwuid,hpwd,validate,vms.opt/opt
$ endif
