...
static const char sccsid[] = "@(#)random.c	4.04 97/07/28 xlockmore";
...
{
	"escher", "gears", "morph3d", "pipes", "rubik",
	"sproingies", "superquadrics"
};
...
{
	"ant", "bug", "demon", "life", "life1d", "life3d", "loop",
	"voters", "wator", "wire"
};
...
{
	"drift", "flame", "forest", "julia", "hop", "ifs", "lightning",
	"mountain", "sierpinski", "strange", "triangle", "turtle", "vines"
};
...
{
	"braid", "fadeplot", "geometry", "helix", "hyper", "ico", "kaleid",
